...
exports.getAllNotifications = exports.getAllUserNotifications = void 0;
var index_1 = require("../prisma/index");
var logger_1 = require("../utils/logger");
var statusCode_1 = require("../utils/statusCode");
var lodash_1 = require("lodash");
var crud_1 = require("./../helpers/crud");
var getAllUserNotifications = function (req, res) { return __awaiter(void 0, void 0, void 0, function () {
    var userId, take, skip, err_1;
    return __generator(this, function (_a) {
        switch (_a.label) {
            ...
            case 1:
                ...
                return [4, (0, crud_1.getAllById)(index_1.prisma.notification, 'userId', userId, take, skip)
                        .then(function (data) {
            ...
            case 3:
                ...
                return [3, 5];
            case 4:
                (0, logger_1.loggerUtil)("Get All User Notifications API Called!");
                return [7];
            case 5: return [2];
        }
    });
    ...
    return __generator(this, function (_a) {
        switch (_a.label) {
            ...
            case 3:
                ...
                return [3, 5];
            case 4:
                (0, logger_1.loggerUtil)("Get All Notifications API Called!");
                return [7];
            case 5: return [2];
        }
    });
