...
var createMany = function (schema, data) {
    return new Promise(function (res, rej) { return __awaiter(void 0, void 0, void 0, function () {
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0: return [4, schema
...
var updateById = function (schema, data, key, id) {
...
var deleteById = function (schema, key, id) {
    if (key === void 0) { key = 'id'; }
    return new Promise(function (res, rej) { return __awaiter(void 0, void 0, void 0, function () {
        var _a;
        return __generator(this, function (_b) {
...
var getById = function (schema, key, id) {
    if (key === void 0) { key = 'id'; }
    return new Promise(function (res, rej) { return __awaiter(void 0, void 0, void 0, function () {
        var _a;
        return __generator(this, function (_b) {
...
var getAll = function (schema, take, skip) {
...
var getAllById = function (schema, key, id, take, skip) {
    if (key === void 0) { key = 'id'; }
    if (take === void 0) { take = 10; }
    if (skip === void 0) { skip = 0; }
    return new Promise(function (res, rej) { return __awaiter(void 0, void 0, void 0, function () {
...
var getAllByQuery = function (schema, queryObj) {
    return new Promise(function (res, rej) { return __awaiter(void 0, void 0, void 0, function () {
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0: return [4, schema
                        .findMany({
                        where: __assign({}, queryObj)
                    })
                        .then(function (response) { return res(response); })
                        .catch(function (err) { return rej(err); })];
                case 1:
